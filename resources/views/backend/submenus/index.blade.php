    ...
    <div class="p-4 sm:ml-64 lg:ml-80">
        <div class="p-6 border-2 border-gray-200 border-dashed rounded-lg bg-white">
            <div class="flex justify-between items-center  mb-6">
                <h2 class="text-2xl font-semibold text-slate-900 mb-6">{{ __('Sub Menu List') }}</h2>
                <a href="{{ route('admin.submenus.create') }}"
                        ...
                        <tr class="bg-white border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-start items-center gap-4">
                                    ...
                                    <button
                                        onclick="window.dispatchEvent(new CustomEvent('open-delete-modal', { detail: { id: '{{ $submenu->id }}', type: 'submenus' } }))"
